<?php 
    $id_guru = mysqli_real_escape_string($conn, $_GET['id_guru']);
    $sql_sw = "SELECT*FROM detail_user NATURAL LEFT JOIN user WHERE id_user= '$id_guru'";
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" value="<?php echo $sklh_user; ?>" class="form-control" name="sklh" placeholder="Masukan Alamat" required>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-default" name="edit_guru">Simpan</button>
      <button type="button" onclick="hapusguru(<?php echo $id_user; ?>)" class="btn btn-danger" name="">Hapus Data</button>
    </div>
  </div>
</form>
<?php
