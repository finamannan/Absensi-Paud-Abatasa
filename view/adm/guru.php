<h3 class='page-header'>Daftar Guru</h3>
<?php 
if (isset($_GET['st'])) {
        if ($_GET['st']==1) {
    ...
    <?php 
        if (isset($_GET['id_guru'])) {
            if ($_GET['id_guru']!=="") {
                ...
                include './view/adm/edit_guru.php';
            } else {
            ...
            echo "<table class='table table-striped' style='width:70%'>
                    ...
                    while ($get_guru = $query_guru->fetch_assoc()) {
                        ...
                        echo "<tr>
                                ...
                                <td><a href='guru&id_guru=$id_guru' title='Edit $name'>Edit info</a> &bullet; <a style='cursor:pointer' onclick='hapusguru($id_guru)' >Hapus Data</a></td>
                            </tr>";
                    }
...
<script src="lib/js/sweetalert2.min.js"></script> <link rel="stylesheet" type="text/css" href="lib/js/sweetalert2.css">
    <script>
        function hapusguru(id_guru) {
            ...
            swal({
                title: 'Anda Yakin?',
                text: 'Semua data Guru akan dihapus!',type: 'warning',
                ...
                closeOnConfirm: true
                    ...
                    window.location.href="./model/proses.php?del_guru="+id;
                });
        }
    </script>
